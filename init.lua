...
vim.g.have_nerd_font = true -- NOTE: Default is false
...
require('lazy').setup({
  ...
  -- TypeScript plugin that adds extra functionality over `ts_ls` LSP server
  --  such as organizing imports, renaming files, etc.
  -- {
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      vim.cmd.colorscheme 'tokyonight-night' -- tomz
    end,
  },
  ...
  { -- Command and uncomment code
    ...
    config = function()
      vim.keymap.set({ 'n', 'v' }, '<A-/>', ':Commentary<CR>', { desc = 'Comment/uncomment' })
    end,
  },
